...
pub struct BookSearchItem {
	...
	#[serde(rename = "id_bibliothèque_nationale_de_france_bnf")]
	pub id_bibliotheque_nationale_de_france_bnf: Option<Vec<String>>,
	...
	pub id_libris: Option<Vec<String>>,
	pub id_freebase: Option<Vec<String>>,
	pub id_harvard: Option<Vec<String>>,
	pub id_lulu: Option<Vec<String>>,
	pub id_etsc: Option<Vec<String>>,
	pub id_bcid: Option<Vec<String>>,
	pub id_boston_public_library: Option<Vec<String>>,
	pub id_nla: Option<Vec<String>>,
	pub id_issn: Option<Vec<String>>,
